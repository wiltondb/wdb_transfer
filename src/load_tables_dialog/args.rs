...
#[derive(Default)]
pub struct LoadTablesDialogArgs {
    pub(super) notice_sender:  ui::SyncNoticeSender,
    pub(super) conn_config: TdsConnConfig,
    pub(super) dbname: String,
}

impl LoadTablesDialogArgs {
    pub fn new(notice: &ui::SyncNotice, conn_config: TdsConnConfig, dbname: &str) -> Self {
        Self {
...
impl ui::PopupArgs for LoadTablesDialogArgs {
