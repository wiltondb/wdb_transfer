...
#[derive(Default)]
pub(super) struct LoadTablesDialogLayout {
    root_layout: nwg::FlexboxLayout,
    buttons_layout: nwg::FlexboxLayout,
}

impl ui::Layout<LoadTablesDialogControls> for LoadTablesDialogLayout {
    fn build(&self, c: &LoadTablesDialogControls) -> Result<(), nwg::NwgError> {
